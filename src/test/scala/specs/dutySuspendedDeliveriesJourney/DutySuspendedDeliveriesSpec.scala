...
class DutySuspendedDeliveriesSpec extends BaseSpec {
  ...
  Feature("Alcohol Duty Return - Duty Suspended Deliveries - Change Link Functionality") {
    ...
    Scenario(
      ...
      DeclareDutySuspendedDeliveriesPage.checkURL
    ...
    DutySuspendedDeliveriesGuidancePage.checkURL
     ...
     // whenIClickContinueButtonOn("Duty Suspended Deliveries Guidance Page")
      ...
      DutySuspendedBeerPage.checkURL
     ...
     // thenIAmPresentedWithThe("Duty Suspended Cider Page")
      DutySuspendedCiderPage.checkURL
     ...
     // whenIClickSaveAndContinueButtonOn("Duty Suspended Cider Page")
      ...
      DutySuspendedWinePage.checkURL
      ...
      DutySuspendedSpiritsPage.checkURL
     ...
     // thenIAmPresentedWithThe("Duty Suspended Other Fermented Products Page")
      DutySuspendedOtherFermentedProductsPage.checkURL
...
//      )
      ...
      DutySuspendedBeerPage.checkNewURL
...
//      )
      ...
      DutySuspendedCiderPage.checkNewURL
...
//      thenIAmPresentedWithTheWithNewUrl("Duty Suspended Wine Page")
      DutySuspendedWinePage.checkNewURL
...
//      )
      ...
      DutySuspendedSpiritsPage.checkNewURL
...
//      )
      ...
      DutySuspendedOtherFermentedProductsPage.checkNewURL
