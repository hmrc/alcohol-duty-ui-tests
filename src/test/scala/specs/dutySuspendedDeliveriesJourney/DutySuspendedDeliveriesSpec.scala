...
import specpage.alcoholDuty.dutySuspendedDeliveries.{DeclareDutySuspendedDeliveriesPage, DutySuspendedBeerPage, DutySuspendedCiderPage, DutySuspendedDeliveriesCheckYourAnswersPage, DutySuspendedDeliveriesGuidancePage, DutySuspendedOtherFermentedProductsPage, DutySuspendedSpiritsPage, DutySuspendedWinePage}
...
//      DeclareDutySuspendedDeliveriesPage.clickRadioButton("Yes")
//
...
//      DeclareDutySuspendedDeliveriesPage.clickSaveAndContinueButton()
...
//      DutySuspendedDeliveriesGuidancePage.clickContinueButton()
...
//      DutySuspendedBeerPage.enterMultipleDetails("2000.75", "Total Beer")
//
...
//      DutySuspendedBeerPage.enterMultipleDetails("150.55", "Pure Alcohol In Beer")
//
...
//      DutySuspendedBeerPage.clickSaveAndContinueButton()
...
//      DutySuspendedCiderPage.enterMultipleDetails("9999.99", "Total Cider")
//
...
//      DutySuspendedCiderPage.clickSaveAndContinueButton()
...
//      DutySuspendedWinePage.enterMultipleDetails("7777.77", "Total Wine")
//
...
//      DutySuspendedWinePage.enterMultipleDetails("77.77", "Pure Alcohol In Wine")
//
...
//      DutySuspendedWinePage.clickSaveAndContinueButton()
...
//      DutySuspendedSpiritsPage.enterMultipleDetails("2100.75", "Total Spirits")
//
//
...
//      DutySuspendedSpiritsPage.enterMultipleDetails("160.55", "Pure Alcohol In Spirits")
//
...
//      DutySuspendedSpiritsPage.clickSaveAndContinueButton()
...
//      DutySuspendedOtherFermentedProductsPage.enterMultipleDetails("8888.88", "Total Other Fermented Products")
//
...
////      )
//      DutySuspendedOtherFermentedProductsPage.enterMultipleDetails("88.88",
//        "Pure Alcohol In Other Fermented Products")
...
//      DutySuspendedOtherFermentedProductsPage.clickSaveAndContinueButton()
...
////      )
//      DutySuspendedDeliveriesCheckYourAnswersPage.clickButton("Change total net quantity of duty suspended beer")
...
//      DutySuspendedBeerPage.enterMultipleDetails("3000.75", "Total Beer")
//
...
//      DutySuspendedBeerPage.enterMultipleDetails("250.55", "Pure Alcohol In Beer")
//
//      And("I click save and continue button on Duty Suspended Beer Page")
//     // whenIClickSaveAndContinueButtonOn("Duty Suspended Beer Page")
//      DutySuspendedBeerPage.clickSaveAndContinueButton()
      ...
      Then("I am presented with the Duty Suspended Deliveries Check Your Answers Page")
     // thenIAmPresentedWithThe("Duty Suspended Deliveries Check Your Answers Page")
      DutySuspendedDeliveriesCheckYourAnswersPage.clickChangeLink("Change total net quantity of pure alcohol in your duty suspended cider")
...
////        "Duty Suspended Deliveries Check Your Answers Page"
////      )
//      DutySuspendedDeliveriesCheckYourAnswersPage.clickButton("Change total net quantity of pure alcohol in your duty suspended cider")
...
//      DutySuspendedCiderPage.enterMultipleDetails("1500.35", "Total Cider")
//
...
//      DutySuspendedCiderPage.enterMultipleDetails("300.55", "Pure Alcohol In Cider")
//
//      And("I click save and continue button on Duty Suspended Cider Page")
////      whenIClickSaveAndContinueButtonOn("Duty Suspended Cider Page")
//      DutySuspendedCiderPage.clickSaveAndContinueButton()
      ...
      Then("I am presented with the Duty Suspended Deliveries Check Your Answers Page")
      //thenIAmPresentedWithThe("Duty Suspended Deliveries Check Your Answers Page")
      DutySuspendedDeliveriesCheckYourAnswersPage.clickChangeLink("Change total net quantity of pure alcohol in your duty suspended wine")
...
////        "Duty Suspended Deliveries Check Your Answers Page"
////      )
//      DutySuspendedDeliveriesCheckYourAnswersPage.clickButton("Change total net quantity of pure alcohol in your duty suspended wine")
//
...
//      DutySuspendedWinePage.enterMultipleDetails("2800.35", "Total Wine")
//
...
//      DutySuspendedWinePage.enterMultipleDetails("160.65", "Pure Alcohol In Wine")
//
//
//      And("I click save and continue button on Duty Suspended Wine Page")
//     // whenIClickSaveAndContinueButtonOn("Duty Suspended Wine Page")
//      DutySuspendedWinePage.clickSaveAndContinueButton()
      ...
      Then("I am presented with the Duty Suspended Deliveries Check Your Answers Page")
      //thenIAmPresentedWithThe("Duty Suspended Deliveries Check Your Answers Page")
      DutySuspendedDeliveriesCheckYourAnswersPage.clickChangeLink("Change total net quantity of pure alcohol in your duty suspended spirits")
...
////        "Duty Suspended Deliveries Check Your Answers Page"
////      )
//      DutySuspendedDeliveriesCheckYourAnswersPage.clickButton("Change total net quantity of pure alcohol in your duty suspended spirits")
//
...
//      DutySuspendedSpiritsPage.enterMultipleDetails("7800.35", "Total Spirits")
//
...
//      DutySuspendedSpiritsPage.enterMultipleDetails("460.55", "Pure Alcohol In Spirits")
//
//      And("I click save and continue button on Duty Suspended Spirits Page")
//     // whenIClickSaveAndContinueButtonOn("Duty Suspended Spirits Page")
//      DutySuspendedSpiritsPage.clickSaveAndContinueButton()
      ...
      Then("I am presented with the Duty Suspended Deliveries Check Your Answers Page")
     // thenIAmPresentedWithThe("Duty Suspended Deliveries Check Your Answers Page")
      DutySuspendedDeliveriesCheckYourAnswersPage.clickChangeLink("Change total net quantity of pure alcohol in your duty suspended other fermented products")
...
////        "Duty Suspended Deliveries Check Your Answers Page"
////      )
//      DutySuspendedDeliveriesCheckYourAnswersPage.clickButton("Change total net quantity of pure alcohol in your duty suspended other fermented products")
//
...
//      DutySuspendedOtherFermentedProductsPage.enterMultipleDetails("8800.35", "Total Other Fermented Products")
//
...
////        "Duty Suspended Other Fermented Products Page"
////      )
//      DutySuspendedOtherFermentedProductsPage.enterMultipleDetails("560.65","Pure Alcohol In Other Fermented Products")
//
//      And("I click save and continue button on Duty Suspended Other Fermented Products Page")
//      //whenIClickSaveAndContinueButtonOn("Duty Suspended Other Fermented Products Page")
//      DutySuspendedOtherFermentedProductsPage.clickSaveAndContinueButton()
...
//      DutySuspendedDeliveriesCheckYourAnswersPage.clickContinueButton()
