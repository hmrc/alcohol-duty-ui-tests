...
object WhatDoYouNeedToDeclareOtherFermentedProductPage extends BasePage {
  ...
  override val url: String    =
    TestConfiguration.url("alcohol-duty-returns-frontend") + "/what-do-you-need-to-declare/OtherFermentedProduct"
  override val newUrl: String =
    TestConfiguration.url("alcohol-duty-returns-frontend") + "/change-what-do-you-need-to-declare/OtherFermentedProduct"
