...
object SingleSmallProducerReliefRateBeerPage extends BasePage {
  ...
  override val url: String    =
    TestConfiguration.url("alcohol-duty-returns-frontend") + "/tell-us-about-single-spr-rate/Beer"
  override val newUrl: String =
    TestConfiguration.url("alcohol-duty-returns-frontend") + "/change-tell-us-about-single-spr-rate/Beer"
  ...
  override def enterMultipleDetails(textToEnter: String, text: String): Unit =
    text match {
      case "Non-draught beer between 1.3% and 3.4% ABV - Total litres"        => enterText("volumesWithRate_0_totalLitres", textToEnter)
      case "Non-draught beer between 1.3% and 3.4% ABV - Pure alcohol litres" => enterText("volumesWithRate_0_pureAlcohol", textToEnter)
      case "Non-draught beer between 1.3% and 3.4% ABV - SPR Rate"            => enterText("volumesWithRate_0_dutyRate", textToEnter)
      case "Non-draught beer between 3.5% and 8.4% ABV - Total litres"        => enterText("volumesWithRate_1_totalLitres", textToEnter)
      case "Non-draught beer between 3.5% and 8.4% ABV - Pure alcohol litres" => enterText("volumesWithRate_1_pureAlcohol", textToEnter)
      case "Non-draught beer between 3.5% and 8.4% ABV - SPR Rate"            => enterText("volumesWithRate_1_dutyRate", textToEnter)
