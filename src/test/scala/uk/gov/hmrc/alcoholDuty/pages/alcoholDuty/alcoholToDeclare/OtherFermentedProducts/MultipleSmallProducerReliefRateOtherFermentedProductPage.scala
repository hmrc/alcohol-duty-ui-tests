...
object MultipleSmallProducerReliefRateOtherFermentedProductPage extends BasePage {
  ...
  override def expectedPageErrorTitle: Option[String] = Some(
    "Error: Tell us about the other fermented products you need to declare that are eligible for Small Producer Relief - Manage your Alcohol Duty - GOV.UK"
  )

  override def expectedPageTitle: Option[String] = Some(
    "Tell us about the other fermented products you need to declare that are eligible for Small Producer Relief - Manage your Alcohol Duty - GOV.UK"
  )
