...
object MultipleSmallProducerReliefRateSpiritsPage extends BasePage {
  ...
  override val url: String =
    TestConfiguration.url("alcohol-duty-returns-frontend") + "/multiple-spr-rates/Spirits"
  override val newUrl: String =
    TestConfiguration.url("alcohol-duty-returns-frontend") + "/change-multiple-spr-rates/Spirits"
  override val title = "Tell us about the spirits you need to declare that are eligible for Small Producer Relief"

  override def expectedPageErrorTitle: Option[String] = Some(
    "Error: Tell us about the spirits you need to declare that are eligible for Small Producer Relief - Manage your Alcohol Duty - GOV.UK"
  )

  override def expectedPageTitle: Option[String] = Some(
    "Tell us about the spirits you need to declare that are eligible for Small Producer Relief - Manage your Alcohol Duty - GOV.UK"
  )

  override def expectedPageHeader: Option[String] = Some(
    "Tell us about the spirits you need to declare that are eligible for Small Producer Relief"
  )
