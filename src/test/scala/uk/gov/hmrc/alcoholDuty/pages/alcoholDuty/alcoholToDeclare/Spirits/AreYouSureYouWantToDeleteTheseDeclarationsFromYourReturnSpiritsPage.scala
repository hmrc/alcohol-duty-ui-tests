...
object AreYouSureYouWantToDeleteTheseDeclarationsFromYourReturnSpiritsPage extends BasePage {

  override val url: String    = TestConfiguration.url(
    "alcohol-duty-returns-frontend"
  ) + "/complete-return/alcoholic-products/Spirits/declare/spr/multiple-duty-rates/missing-details/confirmation"
  override val newUrl: String = TestConfiguration.url(
    "alcohol-duty-returns-frontend"
  ) + "/complete-return/alcoholic-products/Spirits/change/spr/multiple-duty-rates/missing-details/confirmation"
