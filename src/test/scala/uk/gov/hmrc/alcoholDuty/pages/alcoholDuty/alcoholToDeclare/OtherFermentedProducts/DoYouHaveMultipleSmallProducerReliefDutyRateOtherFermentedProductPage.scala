...
object DoYouHaveMultipleSmallProducerReliefDutyRateOtherFermentedProductPage extends BasePage {
  ...
  ) + "/do-you-have-multiple-small-producer-relief-duty-rates/OtherFermentedProduct"
  override val newUrl: String = TestConfiguration.url(
    "alcohol-duty-returns-frontend"
  ) + "/change-do-you-have-multiple-small-producer-relief-duty-rates/OtherFermentedProduct"
