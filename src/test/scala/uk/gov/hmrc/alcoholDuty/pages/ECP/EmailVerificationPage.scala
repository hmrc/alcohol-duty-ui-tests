...
object EmailVerificationPage extends BasePage {
  ...
  override val title = "Enter code to confirm your email address"

  override def expectedPageTitle: Option[String] = Some(
    "Enter code to confirm your email address - Email Verification - GOV.UK" //Add title when page is ready
  )
