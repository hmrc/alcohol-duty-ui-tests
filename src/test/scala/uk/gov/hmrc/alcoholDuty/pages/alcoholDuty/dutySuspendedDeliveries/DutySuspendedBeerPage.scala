...
object DutySuspendedBeerPage extends BasePage {
  ...
  override val url: String = TestConfiguration.url("alcohol-duty-returns-frontend") + "/tell-us-about-your-beer-in-duty-suspense"
  override val newUrl: String = TestConfiguration.url("alcohol-duty-returns-frontend") + "/change-tell-us-about-your-beer-in-duty-suspense"
