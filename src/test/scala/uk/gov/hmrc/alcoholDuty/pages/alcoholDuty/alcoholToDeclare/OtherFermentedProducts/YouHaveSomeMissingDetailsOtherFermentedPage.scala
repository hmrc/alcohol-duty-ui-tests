...
object YouHaveSomeMissingDetailsOtherFermentedPage extends BasePage {
  ...
  override val newUrl: String =
    TestConfiguration.url("alcohol-duty-returns-frontend") + "/complete-return/alcoholic-products/OtherFermentedProduct/declare/spr/multiple-duty-rates/missing-details"
