...
object AreYouSureYouWantToDeleteTheseDeclarationsFromYourReturnCiderPage extends BasePage {

  override val url: String    = TestConfiguration.url(
    "alcohol-duty-returns-frontend"
  ) + "/complete-return/alcoholic-products/Cider/declare/spr/multiple-duty-rates/missing-details/confirmation"
  override val newUrl: String = TestConfiguration.url(
    "alcohol-duty-returns-frontend"
  ) + "/complete-return/alcoholic-products/Cider/change/spr/multiple-duty-rates/missing-details/confirmation"
