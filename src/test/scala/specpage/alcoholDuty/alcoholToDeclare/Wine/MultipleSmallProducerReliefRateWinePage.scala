...
object MultipleSmallProducerReliefRateWinePage extends BasePage {
  ...
  override def clickRadioButton(text: String): Unit =
    text match {
      case "Non-draught wine between 1.3% and 3.4% ABV (363 SPR)" => click(By.cssSelector("#volumesWithRate_taxType"))
      case "Non-draught wine between 3.5% and 8.4% ABV (368 SPR)" => click(By.cssSelector("#volumesWithRate_taxType-2"))
      case "Draught wine between 1.3% and 3.4% ABV (373 SPR)"     => click(By.cssSelector("#volumesWithRate_taxType-3"))
      case "Draught wine between 3.5% and 8.4% ABV (378 SPR)"     => click(By.cssSelector("#volumesWithRate_taxType-4"))
    }
  ...
  def enterDetailsFor368(): Unit = {
    checkURL
    enterMultipleDetails("678.99", "Total litres")
    enterMultipleDetails("66.4300", "Litres of pure alcohol")
    enterMultipleDetails("15.65", "Duty rate")
