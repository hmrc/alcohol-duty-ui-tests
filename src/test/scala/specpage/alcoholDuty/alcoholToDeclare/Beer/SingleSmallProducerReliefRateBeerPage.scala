...
object SingleSmallProducerReliefRateBeerPage extends BasePage {
  ...
  def enterDetailsForAllSprRateBands(): Unit = {
    checkURL
    enterMultipleDetailsWithIndex("888.88", "Non-draught beer between 1.3% and 3.4% ABV - Total litres", 0)
    enterMultipleDetailsWithIndex("99.4500", "Non-draught beer between 1.3% and 3.4% ABV - Pure alcohol litres", 0)
    enterMultipleDetailsWithIndex("15", "Non-draught beer between 1.3% and 3.4% ABV - SPR Rate", 0)
    enterMultipleDetailsWithIndex("776.45", "Non-draught beer between 3.5% and 8.4% ABV - Total litres", 1)
    enterMultipleDetailsWithIndex("78.9000", "Non-draught beer between 3.5% and 8.4% ABV - Pure alcohol litres", 1)
    enterMultipleDetailsWithIndex("18", "Non-draught beer between 3.5% and 8.4% ABV - SPR Rate", 1)
    enterMultipleDetailsWithIndex("776.89", "Draught beer between 1.3% and 3.4% ABV - Total litres", 2)
    enterMultipleDetailsWithIndex("99.9900", "Draught beer between 1.3% and 3.4% ABV - Pure alcohol litres", 2)
    enterMultipleDetailsWithIndex("15", "Draught beer between 1.3% and 3.4% ABV - SPR Rate", 2)
    enterMultipleDetailsWithIndex("889.65", "Draught beer between 3.5% and 8.4% ABV - Total litres", 3)
    enterMultipleDetailsWithIndex("66.5400", "Draught beer between 3.5% and 8.4% ABV - Pure alcohol litres", 3)
    enterMultipleDetailsWithIndex("20", "Draught beer between 3.5% and 8.4% ABV - SPR Rate", 3)
