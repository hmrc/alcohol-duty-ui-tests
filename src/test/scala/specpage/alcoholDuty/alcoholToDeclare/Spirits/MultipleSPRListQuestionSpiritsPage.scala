  ...
  override def clickButton(text: String): Unit =
    text match {
      case "Change hyperlink" =>
        click(By.cssSelector("a[href='/manage-alcohol-duty/complete-return/alcoholic-products/Spirits/declare/spr/multiple-duty-rates/eligible-volume?index=0']"))
      case "Remove hyperlink" =>
        click(By.cssSelector("a[href='/manage-alcohol-duty/complete-return/alcoholic-products/Spirits/declare/spr/multiple-duty-rates/remove-volume?index=0']"))
    }
