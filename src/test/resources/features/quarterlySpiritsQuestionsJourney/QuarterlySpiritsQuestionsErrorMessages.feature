...
Feature: Quarterly Spirits Questions Journey - Error Messages
  ...
  Scenario Outline: Quarterly Spirits Questions - Error Message Validations
    ...
    When I enter "333.33" for "Wheat" on "How Much Grain Have You Used Page"
    When I enter "555.55" for "Rye" on "How Much Grain Have You Used Page"
    When I enter "666.66" for "Unmalted grain" on "How Much Grain Have You Used Page"
